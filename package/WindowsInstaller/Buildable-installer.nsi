/*
Buildable Installer for Windows
Author: Uwe Stöhr
...
# declarations of Buildable's registry keys
...
# install Buildable and needed third-party programs like Python etc.
!include setup\install.nsh

# uninstall Buildable and all programs that were installed together with Buildable
!include setup\uninstall.nsh

# configure Buildable (set start menu and write registry entries)
