...
Settings for Buildable installer

These typically need to be modified for each Buildable release
...
!define APP_EMERGENCY_DOT "" # use "." for an emergency release of Buildable otherwise ""
...
#--------------------------------
# Installer file name
# Typical names for the release are "Buildable-020-Installer-1.exe" etc.
...
#--------------------------------
# installer bit type - Buildable is only provided as 64bit build
