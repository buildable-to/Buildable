...
${LangFileString} TEXT_WELCOME "Denne guide vil installere Buildable på din computer.$\r$\n\
				$\r$\n\
				$_CLICK"
...
${LangFileString} SecCoreDescription "Filerne til Buildable."
#${LangFileString} SecAllUsersDescription "Installer Buildable til alle brugere, eller kun den aktuelle bruger."
${LangFileString} SecFileAssocDescription "Opret association mellem Buildable og .FCStd filer."
...
#${LangFileString} ConfigInfo "Den følgende konfiguration af Buildable vil tage et stykke tid."
...
${LangFileString} AlreadyInstalled "Buildable ${APP_SERIES_KEY2} er allerede installeret!$\r$\n\
...
#${LangFileString} FinishPageMessage "Tillykke!! Buildable er installeret.$\r$\n\
#					$\r$\n\
#					(Når Buildable startes første gang, kan det tage noget tid.)"
${LangFileString} FinishPageRun "Start Buildable"

${LangFileString} UnNotInRegistryLabel "Kunne ikke finde Buildable i registreringsdatabsen.$\r$\n\
					Genvejene på skrivebordet og i Start-menuen bliver ikke fjernet"
${LangFileString} UnInstallRunning "Du ma afslutte Buildable forst!"
${LangFileString} UnNotAdminLabel "Du skal have administrator-rettigheder for at afinstallere Buildable!"
${LangFileString} UnReallyRemoveLabel "Er du sikker på, at du vil slette Buildable og alle tilhørende komponenter?"
...
${LangFileString} SecUnPreferencesDescription 'Sletter Buildable$\'s konfigurations mappe$\r$\n\
						$\"$AppPre\username\$\r$\n\
						$AppSuff\$\r$\n\
						${APP_DIR_USERDATA}$\")$\r$\n\
						for alle brugere.'
...
${LangFileString} SecUnProgramFilesDescription "Afinstallerer Buildable og alle dets komponenter."
