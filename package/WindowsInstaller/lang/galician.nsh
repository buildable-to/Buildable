...
${LangFileString} TEXT_WELCOME "Este asistente vai-no guiar na instalación do Buildable no seu computador.$\r$\n\
				$\r$\n\
				$_CLICK"
...
#${LangFileString} SecAllUsersDescription "Instalar o Buildable monousuário ou multiusuário."
${LangFileString} SecFileAssocDescription "Asociar a extensión .FCStd co Buildable."
${LangFileString} SecDesktopDescription "Cria un icone do Buildable no ambiente de traballo."
...
#${LangFileString} ConfigInfo "A configuración seguinte do Buildable irá demorar un pouco."
...
${LangFileString} AlreadyInstalled "O Buildable ${APP_SERIES_KEY2} xa está instalado!$\r$\n\
...
#${LangFileString} FinishPageMessage "Parabéns! O Buildable foi instalado con suceso.$\r$\n\
#					$\r$\n\
#					(O primeiro início do Buildable pode levar alguns segundos.)"
${LangFileString} FinishPageRun "Lanzar o Buildable"

${LangFileString} UnNotInRegistryLabel "Non se da achado o Buildable no registo.$\r$\n\
					Non se eliminarán os atallos para o ambiente de traballo e no menu de Início."
${LangFileString} UnInstallRunning "Debe fechar o Buildable en primeiro lugar!"
${LangFileString} UnNotAdminLabel "Precisa de priviléxios de administrador para desinstalar o Buildable!"
${LangFileString} UnReallyRemoveLabel "Seguro que quer eliminar completamente o Buildable e todos os seus componentes?"
${LangFileString} UnBuildablePreferencesTitle 'Preferéncias de usuário do Buildable'

#${LangFileString} SecUnProgDescription "Desinstala xxx."
${LangFileString} SecUnPreferencesDescription 'Elimina as pastas de configuración do  Buildable$\r$\n\
						$\"$AppPre\username\$\r$\n\
						$AppSuff\$\r$\n\
						${APP_DIR_USERDATA}$\")$\r$\n\
...
${LangFileString} SecUnProgramFilesDescription "Desinstala Buildable e todos os seus componentes."
