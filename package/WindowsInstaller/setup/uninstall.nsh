...
Section "un.Buildable" un.SecUnProgramFiles
  ...
  DeleteRegKey HKCR "Applications\${BIN_BUILDABLE}"
...
#---------------------------------
# user preferences
Section /o "un.$(UnBuildablePreferencesTitle)" un.SecUnPreferences
 ...
 MessageBox MB_YESNO|MB_DEFBUTTON2|MB_ICONEXCLAMATION $(DialogUnPreferences) /SD IDYES IDYES +2 # continue if yes
  Goto NotPreferences
 # remove Buildable's config files
