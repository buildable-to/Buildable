...
def get_global_sessions_dir() -> Path:
    ...
    sessions_dir = config_dir / "DrawingAssistant" / "sessions"
    sessions_dir.mkdir(parents=True, exist_ok=True)
    return sessions_dir
...
class SessionManager:
    ...
    def load_session(self, session_id: str) -> List[dict]:
        ...
        try:
            with open(session_path, "r", encoding="utf-8") as f:
                ...
                FreeCAD.Console.PrintMessage(f"DrawingAssistant: load_session - {len(messages)} messages, {len(llm_requests)} llm_requests\n")
                ...
                FreeCAD.Console.PrintMessage(f"DrawingAssistant: load_session - attached debug_info to {debug_attached} assistant messages\n")
                return messages
        except Exception as e:
            FreeCAD.Console.PrintError(f"DrawingAssistant: Failed to load session: {e}\n")
            return []
    ...
    def delete_session(self, session_id: str) -> bool:
        ...
        try:
            ...
            FreeCAD.Console.PrintError(f"DrawingAssistant: Failed to delete session: {e}\n")
    ...
    def _save_current_session(self) -> None:
        ...
        try:
            ...
            FreeCAD.Console.PrintError(f"DrawingAssistant: Failed to save session: {e}\n")
